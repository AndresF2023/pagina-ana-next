...
export default function JugadorDetail({
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      {/* ── Correcciones técnicas y biomecánicas ── */}
      <div className={card}>
        <div className="flex items-center justify-between mb-3">
      ...
      <div className={card}>
        <div className="flex items-center justify-between mb-3">
          ...
          {objetivosSaved && <span className="text-xs text-green-600">Guardado</span>}
        </div>
      ...
      <div className={card}>
        <div className="flex items-center justify-between mb-3">
          ...
          {modelosSaved && <span className="text-xs text-green-600">Guardado</span>}
        </div>
      ...
      <div className={card}>
        <div className="flex items-center justify-between mb-3">
          ...
          {identidadConceptualSaved && <span className="text-xs text-green-600">Guardado</span>}
        </div>
      ...
      <div className={card}>
        <div className="flex items-center justify-between mb-3">
          ...
          {identidadEjecutoriaSaved && <span className="text-xs text-green-600">Guardado</span>}
        </div>
        ...
        <div className="flex flex-col gap-4">
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              {estiloCaracteristicasSaved && <span className="text-xs text-green-600">Guardado</span>}
            </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              {estiloPatronesSaved && <span className="text-xs text-green-600">Guardado</span>}
            </div>
          ...
          <form ref={torneoFormRef} onSubmit={(e) => {
            ...
            startTorneoTransition(async () => {
              try {
                ...
                setTorneoList(prev => [...prev, { id: Date.now().toString(), jugador_id: jugador.id, nombre, fecha, lugar, created_at: new Date().toISOString() }].sort((a, b) => a.fecha.localeCompare(b.fecha)));
              ...
              <div key={t.id} className="flex items-center justify-between bg-sky-50 border border-sky-100 rounded-xl px-4 py-3">
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    {formatFecha(t.fecha)}{t.lugar && ` · ${t.lugar}`}
                  </p>
                </div>
                {isStaff && (
